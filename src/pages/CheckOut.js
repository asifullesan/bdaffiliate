...
import { createOrder, deleteCartProduct, getUserCart } from "../features/user/userSlice";
...
const CheckOut = () => {
  const [totalAmount, setTalAmount] = useState(0);
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <button className="btn" type="submit">
                        <span className="btn-text">
                          Payment <i className="far fa-long-arrow-right"></i>
                        </span>{" "}
